...
function sortByAsc(result) {
  ...
  while (stackPointer > 0) {
    stackPointer -= 1;
    const bounds = stack[stackPointer];
    [low] = [bounds[0]];
    [high] = [bounds[1]];
    ...
    if (low < high) {
      ...
      stack[stackPointer] = [low, pivotIndex - 1];
      stackPointer += 1;
      stack[stackPointer] = [pivotIndex + 1, high];
      stackPointer += 1;
    }
  }
